...
[System.Serializable]
public enum EObjectType { NONE = -1, UNIT_01, UNIT_02, UNIT_HERO, MAIN_BASE, TURRET, BUNKER, WALL, BARRACK, NUCLEAR, ENEMY_SMALL, ENEMY_BIG, ENEMY_STRUCTURE, PROCESSING_CONSTRUCT_STRUCTURE,  LENGTH }
...
public enum ENuclearCommand { NONE = -1, SPAWN_NUCLEAR, LAUNCH_NUCLEAR, REMOVE_NUCELAR_FROM_LIST, LENGTH }
...
public enum EHUDCommand { NONE = -1, INIT_WAVE_TIME, UPDATE_WAVE_TIME, INIT_DISPLAY_GROUP_INFO, INIT_DISPLAY_SINGLE_INFO, DISPLAY_GROUP_INFO, DISPLAY_SINGLE_INFO, DISPLAY_SINGLE_STRUCTURE_INFO, HIDE_UNIT_INFO, HERO_RESURRECTION_UPDATE, HERO_RESSURECTION_FINISH, HIDE_ALL_INFO, DISPLAY_TOOLTIP, HIDE_TOOLTIP, UPDATE_TOOLTIP_UPGRADE_COST, INIT_REMAIN_ENEMY_CNT, UPDATE_REMAIN_ENEMY_CNT, WAVE_FINISH,  LENGTH }
...
public enum EHUDMinimapCommand { NONE = -1, ADD_STRUCTURE_NODE_TO_MINIMAP, REMOVE_STRUCTURE_NODE_FROM_MINIMAP, FRIENDLY_SIGNAL, ATTACK_SIGNAL, BIG_ENEMY_SIGNAL, LENGTH }
public enum ECameraCommand { NONE = -1, WARP_WITH_POS, MOVE_WITH_KEY, MOVE_WITH_MOUSE, MOVE_WITH_OBJECT, ZOOM, LENGTH }
public enum ESelectCommand { NONE = -1, TEMP_SELECT, TEMP_UNSELECT, SELECT_START, SELECT_FINISH, REMOVE_FROM_LIST, SAVE_LIST_TO_CROWD, LOAD_CROWD_WITH_IDX, ADD_TO_LIST, LENGTH }
...
public enum EDebugModeCommand { NONE = -1, MOVE_STATE_INDICATOR, DELAY_FAST, MONEY_INFLATION, TOGGLE_FOG, LENGTH }
public enum EMenuCommand { NONE = -1, DISPLAY_MENU, DISPLAY_OPTION, HIDE_MENU, RETURN_MENU, LENGTH }
...
public enum EAlertCommand { NONE = -1, BUILD_COMPLETE, UPGRADE_COMPLETE, UNDER_ATTACK, WAVE_START, LENGTH }

public enum EPublisherType { NONE = -1, SELECTABLE_MANAGER, ENERGY_UPDATE, CORE_UPDATE, POPULATION_MANAGER, LENGTH }
public enum EMessageType { 
    NONE = -1, UPGRADE_RANGED_DMG, UPGRADE_RANGED_HP, 
    UPGRADE_MELEE_DMG, UPGRADE_MELEE_HP, START_SPAWN, 
    STOP_SPAWN, LENGTH 
}
...
public enum EDeveloperMenuKey { NONE = -1, COMMAND_KEY, DISPLAY_STATE_AND_FOGTEXTURE, TOGGLE_FOG, MONEY_INFLATION, FAST_BUILD, LENGTH }
