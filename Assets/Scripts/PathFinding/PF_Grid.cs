...
public class PF_Grid : MonoBehaviour
{
    ...
    {
        //Queue<PF_Node> queueNotVisitedNode = new Queue<PF_Node>();
        //HashSet<PF_Node> hashSetVisitedNode = new HashSet<PF_Node>();
        //List<PF_Node> listNeighborNode = new List<PF_Node>();
