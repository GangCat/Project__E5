...
public class AudioPlayer_WaveBGM : AudioPlayerBase
{
    ...
    public void PlayAudio(EAudioType_WaveBGM _audioType = EAudioType_WaveBGM.NONE)
    {
        if(_audioType == EAudioType_WaveBGM.NONE)
            _audioType = (EAudioType_WaveBGM)UnityEngine.Random.Range(1, (int)EAudioType_WaveBGM.LENGTH); // 1부터 LENGTH-1까지 랜덤 선택
    ...
    public enum EAudioType_WaveBGM { NONE = -1, WaveBGM_01, WaveBGM_02, WaveBGM_03, LENGTH }
}
